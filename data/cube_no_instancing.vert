...
void main() {
    v_Color = u_Color * u_LightColor;
    v_Normal = rotate_vector(u_Rotation, vec3(a_Normal.xyz));
    vec3 world_pos = rotate_vector(u_Rotation, a_Pos.xyz) * u_OffsetScale.w + u_OffsetScale.xyz;
